...
declare namespace Polymer {
   ...
   * async by default.
   */
  function PropertyEffects<T extends new (...args: any[]) => {}>(base: T): T & PropertyEffects.Constructor & Polymer.TemplateStamp.Constructor & Polymer.PropertyAccessors.Constructor;

  namespace PropertyEffects {
