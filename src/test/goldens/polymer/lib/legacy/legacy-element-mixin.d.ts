...
declare namespace Polymer {
   ...
   */
  function LegacyElementMixin<T extends new (...args: any[]) => {}>(base: T): T & LegacyElementMixin.Constructor & Polymer.ElementMixin.Constructor & Polymer.GestureEventListeners.Constructor;

  namespace LegacyElementMixin {
